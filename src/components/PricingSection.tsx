...
export default function PricingSection() {
  ...
  return (
    <section className="bg-[#1a202c] py-24 px-8">
      <div className="max-w-7xl mx-auto">
        {/* Two Column Layout - Equal Height Cards */}
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          {/* Left Column - Introduction Card */}
          <div className="col-span-1 lg:col-span-2 bg-black border border-gray-800 rounded-3xl p-10 min-h-full flex flex-col">
            {/* Badge - Introducing */}
            ...
            <div className="space-y-5 flex-grow">
              {bonuses.map((bonus, index) => (
                <div key={index} className="flex items-start gap-4">
                  {/* Plus Icon Circle */}
                  <div className="w-6 h-6 rounded-full border-2 border-gray-600 flex items-center justify-center flex-shrink-0 mt-0.5">
          ...
          <div className="bg-black border border-gray-800 rounded-3xl p-10 min-h-full flex flex-col">
            ...
            {/* Enroll Button */}
            <button className="w-full bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 rounded-xl transition duration-200 text-base">
              Enroll now
            </button>
          </div>
        </div>
